      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image" style="background: url('<?php echo base_url('assets/img/makkah.jpeg') ?>')"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <?php 
                    ...
                    echo form_open('login/do_login', $attribute); 
                  ?>
