    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Carousel Add</h3>
            </div>
            <?php echo form_open('carousel/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nama_gambar" value="<?php echo $this->input->post('nama_gambar'); ?>" class="form-control" id="nama_gambar" />
